...
#'
#' Creates a named vector to use as the `dqc` or `init` parameter in tti
#' functions.
#'
...
init_dqc <- function(Ds = 0, Da = 0, Qcds = 0, Qhds = 0, Qcda = 0, Qhda = 0,
                     Qq = 0, Cs = 0.8, Ca = 0.2) {
  c(
    Ds = Ds, Da = Da, Qcds = Qcds, Qhds = Qhds, Qcda = Qcda, Qhda = Qhda,
    Qq = Qq, Cs = Cs, Ca = Ca
  )
}
